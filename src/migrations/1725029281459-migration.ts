...
export class Migration1725029281459 implements MigrationInterface {
    name = 'Migration1725029281459'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE \`Auth\` (\`id\` int NOT NULL AUTO_INCREMENT, \`accessToken\` text NOT NULL, \`scope\` varchar(255) NOT NULL, \`idToken\` text NOT NULL, \`tokenType\` varchar(255) NOT NULL, \`expiryDate\` bigint NOT NULL, \`createdAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updatedAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
